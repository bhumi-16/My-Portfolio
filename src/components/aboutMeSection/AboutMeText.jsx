  ...
  return (
    <div className='flex flex-col md:items-start sm:items-center md:text-left sm:text-center'>
      ...
      <p className='text-white'>
        ...
        <br /><br />
        Beyond coding, I love designing intuitive user interfaces, optimizing performance, and exploring emerging tech trends. I'm always open to new opportunities where I can contribute, learn, and grow as a developer.
      </p>
      <a href='#projects' className='border border-orange rounded-full py-2 px-4 txt-lg flex items-center mt-10 hover:bg-orange transition-all duration-500 cursor-pointer md:self-start sm:self-center text-white hover:text-cyan'>
        My Projects
      </a>
    </div>
  );
